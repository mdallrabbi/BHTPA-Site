(function ($) {
    ...
    var lastId, topMenu = $(".mu-menu"), topMenuHeight = topMenu.outerHeight() + 13,
        menuItems = topMenu.find('a[href^=\\#]'), scrollItems = menuItems.map(function () {
    ...
    menuItems.click(function (e) {
        ...
        jQuery('html, body').stop().animate({scrollTop: offsetTop}, 1500);
        e.preventDefault();
    });
    ...
    $('.mu-speakers-slider').slick({
        slidesToShow: 4,
        responsive: [{breakpoint: 768, settings: {arrows: true, slidesToShow: 3}}, {
            breakpoint: 480,
